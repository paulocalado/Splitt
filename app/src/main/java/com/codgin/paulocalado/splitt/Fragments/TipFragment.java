...
public class TipFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView txtTotalMesaTip = (TextView)v.findViewById(R.id.txtTotalMesaTip);

        Bundle bundleHome = this.getArguments();

        table = (Table) bundleHome.getSerializable("table");

        txtTotalMesaTip.setText(getContext().getResources().getString(R.string.text_total_mesa_sem_tip)+
        String.format("%.2f", table.getTotal()));
